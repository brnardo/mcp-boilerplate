...
export function metaAdsAdSetInsightsTool(agent: PaidMcpAgent<Env, any, any>, config: ToolConfig) {
        const {
        ...
        agent.paidTool(
                ...
                "Retrieve ad set-level performance metrics from Meta Ads.",
                requestSchema,
                ...
                },
                {
                        ...
                        paymentReason: REUSABLE_PAYMENT_REASON.replace(
                                "this tool",
                                "Meta Ads ad set insights"
                        ),
                }
        );
}
